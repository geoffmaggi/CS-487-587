...
/**
 * Header pages contain the space map, the file library, and assorted metadata.
 * The first page of the database is subclassed as DBFirstPage. Other header
 * pages are subclassed as DBDirectoryPage.
 */
