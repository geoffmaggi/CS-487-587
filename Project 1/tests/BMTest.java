...
class BMTest extends TestDriver {
	...
	protected boolean test1() {
		...
		for (pid.pid = firstPid.pid; status1 == PASS && pid.pid < lastPid.pid; pid.pid = pid.pid + 1) {
	...
	protected boolean test2() {
		...
		if (Minibase.BufferManager.getNumUnpinned() != 0) {
			status2 = FAIL;
			System.err.print("*** The buffer manager thinks it has " + Minibase.BufferManager.getNumUnpinned()
	...
	protected boolean test3() {
		...
		System.out
				.print("  - Allocate, pin and dirty some new pages, one at " + "a time, and unpin every other page\n");
