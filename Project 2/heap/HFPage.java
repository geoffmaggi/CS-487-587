...
class HFPage extends Page {
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *           if the rid is invalid or input record's length is different.
	 */
	...
	/**
	 * Deletes a record from the page, compacting the records space. RIDs of other
