...
class DirPage extends HFPage {
	...
	protected static final int MAX_ENTRIES = (PAGE_SIZE - HEADER_SIZE - FOOTER_SIZE) / ENTRY_SIZE;
	...
	public PageId getPageId(int slotno) {
		return new PageId(getIntValue(HEADER_SIZE + slotno * ENTRY_SIZE + IX_PAGE_ID));
	}
